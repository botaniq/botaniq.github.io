...
"use strict";$(document).ready(function(){function e(){$(".menu").slideUp(300,function(){$(this).css("display","")}),setTimeout(function(){$(".menu").removeClass("menu-open")},300),$(".burger").removeClass("open")}$(document).on("click",".burger",function(){$(".menu").hasClass("menu-open")?e():($(".menu").addClass("menu-open"),setTimeout(function(){$(".menu").slideDown(300)},100))}),$(".burger").click(function(){$(this).toggleClass("open")}),$(".calendar").datepicker({changeMonth:!0,changeYear:!0});var n=$("#date-from").datepicker({defaultDate:"+1w",changeMonth:!0,numberOfMonths:1}).on("change",function(){s.datepicker("option","minDate",i(this))}),s=$("#date-to").datepicker({defaultDate:"+1w",changeMonth:!0,numberOfMonths:1}).on("change",function(){n.datepicker("option","maxDate",i(this))});function i(e){var n;try{n=$.datepicker.parseDate("mm/dd/yy",e.value)}catch(e){n=null}return n}$(document).on("click",".button-calendar",function(){$(this).prev(".calendar").trigger("focus")});var a=$("#backToTop");$(window).scroll(function(){300<$(window).scrollTop()?a.addClass("show"):a.removeClass("show")}),a.on("click",function(e){e.preventDefault(),$("html, body").animate({scrollTop:0},"300")}),$(function(){$("#countryList").change(function(){var e=$(this).val();console.log(e),"usa"!==e?($(".registration-window-lg").addClass("disabledForm"),$(".disabledForm input").prop("disabled",!0),$(".disabledForm select").not("#countryList").prop("disabled",!0)):$(".registration-window-lg").hasClass("disabledForm")&&($(".disabledForm input").prop("disabled",!1),$(".disabledForm select").not("#countryList").prop("disabled",!1),$(".registration-window-lg").removeClass("disabledForm"))})}),$(function(){$("#doc-select").change(function(){$("#drivers").slideToggle(function(){})})}),$(function(){$(".officer-name").hide(),$("input:radio[name='sponsorship_level']").change(function(){"personal"==$(this).attr("value")&&($(".officer-name").hide(),$(".business-name").hide(),$(".client-first-name").show()),"business"==$(this).attr("value")&&($(".officer-name").show(),$(".business-name").show(),$(".client-first-name").hide())})}),$(function(){$("input[name='llc-main']").change(function(){$(this).prop("checked")?($(".useless input").prop("disabled",!0),$(".message-for-uploading").addClass("show"),$(".useless input").prop("disabled",!1)):($(".useless input").prop("disabled",!1),$(".message-for-uploading").removeClass("show"),$(".useless input").prop("disabled",!0))})}),$(function(){$.widget("custom.iconselectmenu",$.ui.selectmenu,{_renderItem:function(e,n){var s=$("<li>"),i=$("<div>",{text:n.label});return n.disabled&&s.addClass("ui-state-disabled"),$("<span>",{style:n.element.attr("data-style"),class:"ui-icon "+n.element.attr("data-class")}).appendTo(i),s.append(i).appendTo(e)}}),$(".select").iconselectmenu({change:function(e,n){var s=n.item.element.attr("data-class"),i=n.item.element.closest("select").siblings(".calc").find(".changed-icon"),a=i.attr("class").slice(13);i.removeClass(a).addClass(s)}}).iconselectmenu("menuWidget").addClass("ui-menu-icons customicons"),$(".ui-button").append("<span class='icon-arrow-down'></span>")});var t=new Date("2019.01.01").getTime()/1e3,o=(new Date).getTime()/1e3;$("#slider-range").slider({range:!0,min:t,max:o,step:86400,values:[t,o],slide:function(e,n){$(".slider #from").val(new Date(1e3*n.values[0]).toDateString()),$(".slider #to").val(new Date(1e3*n.values[1]).toDateString())}}),$(".slider #from").val(new Date(1e3*$("#slider-range").slider("values",0)).toDateString().slice(0,10)),$(".slider #to").val(new Date(1e3*$("#slider-range").slider("values",1)).toDateString().slice(0,10)),$(".btn-click").on("click",function(){var e=$(this).siblings(".popup");$(".visible").removeClass("visible"),e.toggleClass("visible"),$(".popup-close").on("click",function(){e.removeClass("visible")})}),$(".modal-btn").on("click",function(){var e=$(this).data("modal");console.log(e),$("body").addClass("modal-open").css("padding-right",d),$(".modal-window").addClass("open"),$(".fixed-header").css("right",d)}),$(".closing").on("click",function(){$(this).parents(".modal-window").removeClass("open"),$(".modal-window").hasClass("open")||setTimeout(function(){$("body").removeClass("modal-open").css("padding-right",""),$(".fixed-header").css("right","0")},300)});var l,d=(l=parseInt(document.documentElement.clientWidth),parseInt(window.innerWidth)-l);$(".modal-window").css("padding-right",d),$(".scroll-emul").css("width",d),$(".selectmenu").selectmenu(),$('.disabled-until-choise input[type="radio"]').change(function(){$(this).hasClass("disable")?($(this).siblings().find(".disabled").prop("disabled",!1),$(this).siblings(".disabled").prop("disabled",!1)):$(".disabled-until-choise").find(".disabled").prop("disabled",!0)}),lgScreen=function(){c.matches&&$(".menu").hasClass("menu-open")&&e()},lgScreen(),c.addListener(lgScreen)});window.matchMedia("(max-width: 575px)"),window.matchMedia("(min-width: 576px) and (max-width: 991px)");var c=window.matchMedia("(min-width: 992px)");
"use strict";$(document).ready(function(){function s(){$(".hot-coin").hasClass("slick-initialized")&&$(".hot-coin").slick("unslick"),$(".hot-coin").slick(lg.matches?{arrows:!1,vertical:!0,verticalSwiping:!0,dots:!0,slidesToShow:4,slidesToScroll:4,autoplay:!1}:md.matches?{arrows:!1,dots:!0,slidesToShow:2,slidesToScroll:2,autoplay:!1}:xs.matches?{arrows:!1,dots:!0,slidesToShow:1,slidesToScroll:1,autoplay:!1}:void 0),$(".hot-coin").append($(".slick-list .slick-dots")),smartDots(),$(".hot-coin").on("swipe",function(i,s,e){var a=$(".slick-dots .slick-active");buildDots(a)})}function e(){$(".advantages-block.slick-initialized").slick("unslick"),$(".slide-abilities.slick-initialized").slick("unslick"),$(".steps-content.slick-initialized").slick("unslick")}initChart("homepage-chart");for(var a=$(".abilities-paragraph"),t=[],i=0;i<a.length;i++)t.push(a.eq(i).html());var l=function(i){for(;90<i.text().length;)i.text(function(i,s){return s.replace(/\W*\s(\S)*$/,"...")}),i.addClass("cut")};function n(){$(".abilities-paragraph").off();for(var i=0;i<a.length;i++){var s=a.eq(i);s.hasClass("cut")&&s.html(t[i]).removeClass("cut")}}function o(){$(".advantage").mouseenter(function(){$(this).addClass("active-advantage").siblings().removeClass("active-advantage")}),$(".advantage").mouseleave(function(){$(".advantage:eq(1)").addClass("active-advantage").siblings().removeClass("active-advantage")})}lgScreen=function(i){i.matches&&(s(),e(),lg.matches&&$(".abilities-paragraph").each(function(){var s=$(this);l(s),s.on("mouseenter",function(){var i=$(this).parent().index();s.html(t[i]).removeClass("cut")}),s.on("mouseleave",function(){l(s)})}),o())},mdScreen=function(i){i.matches&&(s(),e(),n(),o())},xsScreen=function(i){i.matches&&(s(),$(".advantages-block").not(".slick-initialized").slick({slidesToShow:1,slidesToScroll:1,adaptiveHeight:!0}),$(".slide-abilities").not(".slick-initialized").slick({slidesToShow:1,slidesToScroll:1,adaptiveHeight:!0}),$(".steps-content").not(".slick-initialized").slick({slidesToShow:1,slidesToScroll:1,infinite:!1}),$(".slick-next").addClass("icon-arrow-right"),$(".slick-prev").addClass("icon-arrow-left"),n())},lgScreen(lg),mdScreen(md),xsScreen(xs),lg.addListener(lgScreen),md.addListener(mdScreen),xs.addListener(xsScreen)});
"use strict";